  ...
  return (
    <>
      <div className="max-w-2xl text-left">
        ...
        {paragraph && (
          <div className="my-10 text-md leading-8 text-gray-600">To start a new conversation with <b>Q</b> please {collectionId ? 'upload a document you want him to study.' : 'select a collection or create one'} </div>
        )}
      </div>
    </>
  );
