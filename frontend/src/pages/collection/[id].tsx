                    ...
                    <div className="flex flex-col relative rounded-md">
                        <div className="h-full overflow-auto" style={{ maxHeight: isMobile ? '100%' : tableHeight }}>
                            <table className="relative border-collapse overflow-auto table-auto w-full text-sm shadow-sm rounded-md">
                                <thead>
                                    <tr>
                                        <th className="sticky top-0 bg-slate-50 border-b font-medium py-3 text-slate-400 text-left p-4">Name</th>
                                        <th className="sticky top-0 bg-slate-50 border-b font-medium py-3 text-slate-400 text-left p-4">Date</th>
                                        <th className="sticky top-0 bg-slate-50 border-b font-medium py-3 text-slate-400 text-left p-4">Status</th>
                                        <th className="sticky top-0 bg-slate-50 border-b font-medium py-3 text-slate-400 text-left p-4">Download</th>
                                    </tr>
                                </thead>
